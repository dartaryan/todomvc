...
import {BUTTONS_DATA, CARD_DATA, FOOTER_DATA, HEADER_DATA, INFO_SECTION_DATA, TAB_DATA} from './types/shared-ui.const';

@Component({
    selector: 'todomvc-shared-ui',
    standalone: true,
    imports: [CommonModule, TodoHeaderComponent, TodoCardComponent, TodoInputComponent, TodoTabComponent, TodoFooterComponent, TodoButtonComponent, TodoInfoSectionComponent, TodoNavigationComponent],
